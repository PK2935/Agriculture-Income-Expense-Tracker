...
const TransactionForm = () => {
  ...
  return (
    <div className="transaction-form">
      ...
      <textarea value={description} onChange={handleDescriptionChange} placeholder='Enter more about the transaction' />
      <label>Amount:</label>
      <input type="number" value={amount} onChange={handleAmountChange} placeholder='Transaction Amount' />
      <label>Date:</label>
      <input type="date" value={date} onChange={handleDateChange} />
      {!isDateValid && <p style={{ color: 'red' }}>Please select the current date for the transaction.</p>}
